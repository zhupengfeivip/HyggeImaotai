...
namespace hygge_imaotai {
    ...
    public partial class App : Application {
        ...
        public static readonly string _configFile = Path.Combine(CacheDir, "config.json");
        ...
        protected override async void OnStartup(StartupEventArgs e) {
            ...
            if (Config.AutoBuy) {
                ...
                var trigger = TriggerBuilder.Create().WithCronSchedule($"{Config.BuyStartSecond} {Config.BuyStartMinute} {Config.BuyStartHour} ? * * ").Build();
